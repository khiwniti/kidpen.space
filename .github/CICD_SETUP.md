...
|--------|-------------|----------|-------------|
| `main` | DEV | dev-api.kidpen.com | ✅ On push |
| `staging` | STAGING | staging-api.kidpen.com | ✅ On push |
| `PRODUCTION` | PRODUCTION | api.kidpen.com | ✅ On push |
...
Pulumi Cloud: https://app.pulumi.com/kidpen
