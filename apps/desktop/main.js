...
const PROTOCOL_SCHEME = 'kidpen';

// Get URL from environment variable or default to production
const APP_URL = process.env.APP_URL || 'https://kidpen.com/';
...
// Register as default protocol handler for kidpen://
...
function handleDeepLink(url) {
  ...
  // Convert kidpen://auth/callback?code=xxx to https://kidpen.com/auth/callback?code=xxx
...
function createWindow() {
  ...
  webContents.setUserAgent(webContents.getUserAgent() + ' Electron/Kidpen-Desktop');
