...
Minimal Electron wrapper for the Kidpen web application with deep linking support.

## Features

- Native macOS/Windows/Linux desktop app
- Deep linking for magic link authentication (`kidpen://` protocol)
...
By default, it loads `https://kidpen.com/`.
...
The app registers the `kidpen://` protocol for magic link authentication:

1. User enters email in desktop app
2. Magic link email contains `kidpen://auth/callback?code=xxx`
3. User clicks link in email
4. Operating system opens Kidpen Desktop app
