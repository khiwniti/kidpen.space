...
export const pricingTiers: PricingTier[] = [
  {
    ...
    description: 'Perfect for trying out Kidpen AI Workers',
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create Kidpen Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create Kidpen Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create Kidpen Workers with custom Knowledge, Tools & Integrations',
