...
const ELECTRON_PROTOCOL = 'kidpen';
...
export function isElectron(): boolean {
  ...
  // Check user agent for Electron (we append "Electron/Kidpen-Desktop" in main.js)
 ...
 * - Web: returns the web URL (https://kidpen.space/auth/callback)
 * - Electron: returns the custom protocol URL (kidpen://auth/callback)
 */
