...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Kidpen',
    description: 'Replay this Worker conversation on Kidpen',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Kidpen';
    const description =
      projectData.description ||
      'Replay this Worker conversation on Kidpen';
