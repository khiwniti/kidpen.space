...
const paragraphs: ParagraphItem[] = [
  ...
  "Kidpen is an AI agent that doesn't just give you answers—it gets things done. Research, code, write, manage projects, execute workflows. The whole job.",
        ...
        <div className="mt-24 md:mt-32">
          ...
          <div className="md:hidden border border-foreground/10 rounded-sm p-6">
            ...
            <div className="text-center mt-6">
              <Image src="/kidpen-symbol.svg" alt="Kidpen" width={16} height={13} className="inline-block opacity-20 dark:invert" />
            </div>
          </div>
