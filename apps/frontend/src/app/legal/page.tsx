                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        Kidpen AI Corp is responsible for the content of this
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        CAREFULLY BEFORE USING THE SERVICES OFFERED BY Kidpen AI
                        ...
                        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE Kidpen
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        <li>
                          "Company" refers to Kidpen AI Corp, a Delaware corporation
                          with its principal place of business at 701 Tillery Street
                          Unit 12-2521, Austin, Texas 78702, United States.
                        </li>
                        <li>
                          "Site" refers to the Kidpen website, including any related
                          features, content, or applications offered from time to
                          time by the Company.
                        </li>
                        <li>
                          "Service" refers to the Kidpen platform and all related
                        ...
                        <li>
                          ...
                          Company, specifically legal@kidpen.space
                        </li>
                        <li>
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        Kidpen is a complete platform for creating, managing, and
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        <a
                          href="https://github.com/kidpen-ai/suna/blob/main/LICENSE"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-primary hover:underline"
                        >
                          github.com/kidpen-ai/suna/blob/main/LICENSE
                        </a>
                      </p>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        please write to legal@kidpen.space and we will process and
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        or by emailing us at info@kidpen.space. If you cancel
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        GitHub repository. Self-hosting is governed by the Kidpen Public
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All Kidpen logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE Kidpen WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        Kidpen DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        <a
                          href="mailto:legal@kidpen.space"
                          className="text-primary hover:underline"
                        >
                          legal@kidpen.space
                        </a>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        <strong>Mailing Address:</strong> Kidpen AI Corp, 701 Tillery
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at Kidpen in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        Kidpen does not collect biometric or identifying
