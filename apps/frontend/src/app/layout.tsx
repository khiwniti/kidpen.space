...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Kidpen Team', url: 'https://kidpen.space' }],
  creator: 'Kidpen Team',
  publisher: 'Kidpen Team',
    ...
    <html lang="th" suppressHydrationWarning className={`${outfit.variable} ${ibmPlexSansThai.variable} ${jetbrainsMono.variable}`}>
      <head>
        ...
        {!featureFlags.disableMobileAdvertising ? (
          <meta name="apple-itunes-app" content="app-id=6754448524, app-argument=kidpen://" />
        ) : null}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [siteMetadata.name, 'Kidpen'],
