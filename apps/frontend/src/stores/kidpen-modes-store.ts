...
export const useKidpenModesStore = create<KidpenModesState>()(
  persist(
    (set, get) => ({
      selectedMode: null,
      selectedCharts: [],
      ...
      setSelectedMode: (mode: string | null) => {
        ...
        const updates: Partial<KidpenModesState> = { selectedMode: mode };
    ...
    {
      name: 'kidpen-modes-storage',
      // Version 4: Migrated from suna-modes-storage
      version: 4,
...
export const useSunaModesStore = useKidpenModesStore;
...
export const useSunaModePersistence = useKidpenModePersistence;
