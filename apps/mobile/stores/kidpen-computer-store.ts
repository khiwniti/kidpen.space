...
export const useKidpenComputerStore = create<KidpenComputerState>((set, get) => ({
  ...initialState,
...
export const useKidpenComputerIsOpen = () =>
  useKidpenComputerStore((state) => state.isOpen);
...
export const useKidpenComputerSelectedVersion = () =>
  useKidpenComputerStore((state) => state.selectedVersion);

export const useKidpenComputerSelectedVersionDate = () =>
  useKidpenComputerStore((state) => state.selectedVersionDate);

export const useKidpenComputerVersionActions = () =>
