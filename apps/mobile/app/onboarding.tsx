    ...
    <>
      ...
      <View className="flex-1 bg-background">
        ...
        <View className="pt-14 px-6 pb-2 flex-row justify-between items-center">
          <KidpenLogo variant="logomark" size={14} color={isDark ? 'dark' : 'light'} />
          <TouchableOpacity
        ...
        <View className="flex-1 p-4">
          ...
          <View className="flex-1">
            <View className="flex-row items-center gap-1.5 mb-2">
              <KidpenLogo variant="symbol" size={14} color={isDark ? 'dark' : 'light'} />
...
function SpinningLoader() {
  return <KidpenLoader size="small" customSize={16} />;
}
