...
import { KidpenLoader } from '@/components/ui';
...
import KidpenSymbolBlack from '@/assets/brand/kidpen-symbol-scale-effect-black.svg';
import KidpenSymbolWhite from '@/assets/brand/kidpen-symbol-scale-effect-white.svg';
...
function AuthBackgroundLogo() {
  ...
  const SymbolComponent = colorScheme === 'dark' ? KidpenSymbolWhite : KidpenSymbolBlack;
  ...
  return (
    ...
    >
        ...
        <View style={{ marginBottom: SPACING.logoToTitle }}>
          <KidpenLogo variant="logomark" size={24} color={isDark ? 'dark' : 'light'} />
        </View>
