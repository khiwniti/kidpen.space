...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    const handleDeepLink = async (event: { url: string }) => {
      ...
      // Check for universal links (https://kidpen.space/share/xxx or https://staging.kidpen.space/share/xxx)
      const isUniversalLink = parsedUrl.scheme === 'https' &&
        (parsedUrl.hostname === 'kidpen.space' ||
          parsedUrl.hostname === 'www.kidpen.space' ||
          parsedUrl.hostname === 'staging.kidpen.space');
      ...
      // Handle custom scheme: kidpen://auth/callback
      if (parsedUrl.hostname === 'auth' && parsedUrl.path === 'callback') {
        ...
        // Handle share links: kidpen://share/xxx or https://kidpen.space/share/xxx
        ...
        if (parsedUrl.path?.startsWith('share/')) {
          ...
          // Custom scheme format: kidpen://share/xxx -> hostname=share, path=xxx
