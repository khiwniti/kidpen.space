...
import { KidpenComputer } from '@/components/kidpen-computer';
...
export default function ShareThreadPage() {
  ...
  // Kidpen Computer for viewing tool calls
  const { isOpen: isKidpenComputerOpen, openPanel } = useKidpenComputerStore();
  const [selectedToolData, setSelectedToolData] = React.useState<{
    toolMessages: ToolMessagePair[];
    initialIndex: number;
  } | null>(null);

  // Handle tool press - open Kidpen Computer
