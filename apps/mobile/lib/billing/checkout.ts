 ...
 * 
 * Note: The backend should return kidpen.space URLs that wrap/proxy Stripe,
...
// checkout URLs (should be kidpen.space masked URLs, not direct stripe.com)
// ============================================================================
 ...
 * a kidpen.space masked URL (not direct stripe.com for compliance)
 */
...
export async function openBillingPortal(returnUrl?: string): Promise<void> {
  ...
  try {
    ...
    const webBillingUrl = process.env.EXPO_PUBLIC_WEB_APP_URL 
      ...
      : 'https://www.kidpen.space/subscription';
