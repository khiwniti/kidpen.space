...
import KidpenSymbolBlack from '@/assets/brand/kidpen-symbol.svg';
import KidpenSymbolWhite from '@/assets/brand/Symbol.svg';
import LogomarkBlack from '@/assets/brand/Logomark-Black.svg';
import LogomarkWhite from '@/assets/brand/Logomark-White.svg';

interface KidpenLogoProps extends Omit<ViewProps, 'style'> {
  size?: number;
...
export function KidpenLogo({ 
  ...
  const SymbolComponent = color === 'dark' ? KidpenSymbolWhite : KidpenSymbolBlack;
