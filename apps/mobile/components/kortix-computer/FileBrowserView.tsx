...
import { KidpenComputerHeader, type BreadcrumbSegment } from './KidpenComputerHeader';
      ...
      <KidpenComputerHeader
        ...
        actions={
          <View className="flex-row items-center gap-1.5">
            ...
            >
              {isUploading ? (
                <KidpenLoader size="small" customSize={17} />
              ) : (
                <Icon
                  as={Upload}
                  size={17}
          ...
          <View className="w-full max-w-md rounded-2xl p-4 bg-card border border-border">
            ...
            <View className="flex-row gap-2">
              ...
              >
                {isReverting ? (
                  <View className="flex-row items-center gap-2">
                    <KidpenLoader size="small" customSize={14} forceTheme="dark" />
