...
const apiWorkload = new ApiWorkload("suna-api", {
  ...
  ingress: {
    enabled: true,
    host: config.get("primaryDomain") || "api-eks.kidpen.com",
    annotations: {
...
export const outputs = {
  ...
  endpoints: {
    primary: config.get("primaryDomain") || "api-eks.kidpen.com",
    lightsail: config.get("lightsailDomain") || "api-lightsail.kidpen.com",
  },
};
