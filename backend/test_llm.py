...
Tests kidpen/basic and kidpen/power models with the configured MAIN_LLM provider.
"""
...
async def main():
    ...
    print("\n[kidpen/basic]")
    basic_model = print_model_info("kidpen/basic")
    
    print("\n[kidpen/power]")
    power_model = print_model_info("kidpen/power")
    
    print("\n[kidpen/grok-4-1-fast]")
    grok_model = print_model_info("kidpen/grok-4-1-fast")
    ...
    print("\n[Testing kidpen/basic]")
    basic_ok = await test_llm_call("kidpen/basic")
    
    print("\n[Testing kidpen/power]")
    power_ok = await test_llm_call("kidpen/power")
    ...
    print("Summary")
    print("=" * 60)
    print(f"  kidpen/basic:  {'✓ PASS' if basic_ok else '❌ FAIL'}")
    print(f"  kidpen/power:  {'✓ PASS' if power_ok else '❌ FAIL'}")
    print()
