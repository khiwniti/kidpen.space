...
class MarketplaceFilters:
    def __init__(
        ...
        is_kidpen_team: Optional[bool] = None,
        ...
        self.search = search
        self.tags = tags or []
        self.is_kidpen_team = is_kidpen_team
...
class MarketplaceService:
    ...
    async def get_marketplace_templates_paginated(
        ...
        try:
            ...
            templates = await template_service.get_public_templates(
                is_kidpen_team=filters.is_kidpen_team,
                limit=limit,
                offset=offset,
    ...
    def _build_marketplace_base_query(self, filters: MarketplaceFilters):
        ...
        if filters.is_kidpen_team is not None:
            query = query.eq('is_kidpen_team', filters.is_kidpen_team)
