...
class InstallationService:
    ...
    async def _create_agent(
        ...
        if template.is_kidpen_team:
            metadata['is_kidpen_team'] = True
            metadata['kidpen_template_id'] = template.template_id
        ...
        logger.debug(f"Created agent {agent_id} from template {template.template_id}, is_kidpen_team: {template.is_kidpen_team}")
        return agent_id
