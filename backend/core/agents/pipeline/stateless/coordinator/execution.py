    ...
    async def execute_step(self) -> AsyncGenerator[Dict[str, Any], None]:
        ...
        if has_archive:
            archive_preamble = (
                ...
                "files at /workspace/.kidpen/context/ BEFORE answering. Do NOT guess or use general knowledge.\n\n"
            )
            archive_hint = (
                ...
                "**For links/URLs:** read_file /workspace/.kidpen/context/messages/batch_NNN/links.md\n"
                "**For specific data:** grep -ri \"keyword\" /workspace/.kidpen/context/messages/\n"
                "**To see all files:** read_file /workspace/.kidpen/context/messages/batch_NNN/index.md\n"
