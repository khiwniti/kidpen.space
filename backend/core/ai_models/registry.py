...
FREE_MODEL_ID = "kidpen/minimax"
PREMIUM_MODEL_ID = "kidpen/power"
IMAGE_MODEL_ID = "kidpen/haiku"
...
class ModelFactory:
    ...
    def create_basic_model(main_llm: str, custom_model: Optional[str] = None) -> Model:
        ...
        if main_llm == "kimi":
            return Model(
                ...
                provider=ModelProvider.OPENROUTER,
                aliases=["kidpen-basic", "Kidpen Basic"],
    ...
    def create_test_model() -> Model:
        return Model(
            ...
            provider=ModelProvider.OPENROUTER,
            aliases=["kidpen-test", "Kidpen Test"],
            context_window=200_000,
            capabilities=[
                ModelCapability.CHAT,
                ModelCapability.FUNCTION_CALLING,
