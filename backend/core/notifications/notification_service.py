...
KIDPEN_HELLO_EMAIL = 'hello@kidpen.com'
...
class NotificationService:
    ...
    async def send_task_completion_notification(
        ...
        try:
            ...
            task_url = f"https://www.kidpen.com/projects/{project_id}/thread/{thread_id}" if project_id else f"https://www.kidpen.com/thread/{thread_id}"
