...
#   STRESS_TEST_HOST_HEADER=api.yourdomain.com  (optional, defaults to api.kidpen.com)
STRESS_TEST_ALB_URL = os.getenv("STRESS_TEST_ALB_URL")
STRESS_TEST_HOST_HEADER = os.getenv("STRESS_TEST_HOST_HEADER", "api.kidpen.com")
