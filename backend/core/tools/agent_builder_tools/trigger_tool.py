        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "include_kidpen": {
                        "type": "boolean",
                        "description": "Whether to include the built-in Kidpen worker in results. Defaults to false."
                    }
                },
                "required": []
            }
    ...
    async def list_account_workers(
        ...
        try:
            ...
            for worker in workers:
                ...
                is_kidpen = bool(metadata.get('is_kidpen_default'))
                name = worker.get('name') or 'Untitled Worker'

                if not include_kidpen and is_kidpen:
                    continue
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {
                        "type": "string",
                        "description": "Model to use for the scheduled execution. Options: 'kidpen/basic' (default, free tier) or 'kidpen/power' (requires paid subscription). If not specified, defaults to 'kidpen/basic'."
                    }
                },
        ...
        try:
            ...
            for trigger in schedule_triggers:
                formatted = {
                    ...
                    "model": trigger.config.get("model", "kidpen/basic"),
                    "is_active": trigger.is_active
                }
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {"type": "string", "description": "Model to use for the event execution. Options: 'kidpen/basic' (default, free tier) or 'kidpen/power' (requires paid subscription). If not specified, defaults to 'kidpen/basic'."}
                },
