...
2. Build a custom image:
   ...
   docker push kidpen/suna:0.1.3.30
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `kidpen/suna:___`)
...
3. Push the new version: `docker push kidpen/suna:0.1.3`
