...
allowed_origins = [
    "https://www.kidpen.com",
    "https://kidpen.com",
    "https://dev.kidpen.com",
    "https://staging.kidpen.com",
    "https://prod-test.kidpen.com",
]
# Allow all *.kidpen.com subdomains and Vercel preview deployments
allow_origin_regex = r"https://([a-z0-9-]+\.)?kidpen\.com|https://.*-kidpenai\.vercel\.app"
...
if config.ENV_MODE == EnvMode.STAGING:
    allowed_origins.append("https://staging.kidpen.com")
    allowed_origins.append("http://localhost:3000")
