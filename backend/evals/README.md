# Kidpen Agent Evaluations

Evaluate Kidpen agent performance using **Braintrust** with JSON-based test cases.
...
Results are automatically uploaded to: https://www.braintrust.dev/app/Kidpen/p/Kidpen%20Agent/experiments/
...
| `EVAL_MODEL` | Override model for evals (default: `kidpen/basic`) |
