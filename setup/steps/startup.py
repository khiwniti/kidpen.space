...
class StartupStep(BaseStep):
    """Start Kidpen services."""

    name = "startup"
    display_name = "Starting Kidpen"
    order = 16
    required = True
    ...
    def run(self) -> StepResult:
        ...
        self.info("\nHow would you like to start Kidpen?")
    ...
    def _start_docker(self, choice: str, compose_cmd_str: str) -> StepResult:
        ...
        if choice == "1":
            ...
            self.info("Starting Kidpen with Docker Compose...")
            ...
            try:
                ...
                if "backend" in result.stdout and "frontend" in result.stdout:
                    self.success("Kidpen services are starting up!")
                else:
                    self.warning(
    ...
    def _start_manual(self, choice: str, compose_cmd_str: str) -> StepResult:
        ...
        if choice == "1":
            ...
            self.info("Starting Kidpen automatically (manual mode)...")
            ...
            try:
                ...
                self.success("Kidpen services started!")
                self.info("Access Kidpen at: http://localhost:3000")
                self.info("\nTo view logs:")
