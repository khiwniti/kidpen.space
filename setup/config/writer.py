...
class ConfigWriter:
    ...
    def write_backend_env(self, config: SetupConfig) -> Tuple[bool, str]:
        ...
        env_vars = {
            ...
            # Kidpen
            "KIDPEN_ADMIN_API_KEY": config.kidpen.KIDPEN_ADMIN_API_KEY,
            # VAPI
        ...
        header = f"Generated by Kidpen Suna setup for '{setup_method}' setup"
    ...
    def write_frontend_env(self, config: SetupConfig) -> Tuple[bool, str]:
        ...
        header = "Generated by Kidpen Suna setup"
        content = self._format_env_content(env_vars, header)
