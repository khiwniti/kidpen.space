...
class MainLLMProvider(str, Enum):
    """Main LLM provider for kidpen/basic model."""
...
class KidpenConfig(BaseModel):
    """Kidpen admin configuration."""

    KIDPEN_ADMIN_API_KEY: str = ""
...
class SetupConfig(BaseModel):
    ...
    kidpen: KidpenConfig = Field(default_factory=KidpenConfig)
