...
from setup.steps.kidpen import KidpenStep
...
class SetupWizard:
    ...
    def _sync_step_completion(self) -> None:
        ...
        optional_steps = ["morph", "search_apis", "rapidapi", "kidpen", "webhook", "mcp"]
    ...
    def run(self) -> int:
        ...
        self.console.print(
            "This wizard will guide you through setting up Kidpen Suna, "
    ...
    def _show_final_instructions(self) -> None:
        ...
        self.console.print("\n✨ Kidpen Suna Setup Complete! ✨\n")

        self.console.info("Kidpen Suna is configured with your API keys and ready to use.")
        ...
        if self.config.setup_method == SetupMethod.DOCKER:
            self.console.info("Your Kidpen Suna instance is ready to use!")
            ...
            self.console.info("To start Kidpen Suna, run these commands in separate terminals:")
        ...
        self.console.print("\nOnce all services are running, access Kidpen Suna at: http://localhost:3000")
