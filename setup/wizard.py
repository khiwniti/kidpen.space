...
class SetupWizard:
    ...
    def run(self) -> int:
        ...
        self.console.print(
            "This wizard will guide you through setting up Kidpen, "
    ...
    def _show_final_instructions(self) -> None:
        ...
        self.console.print("\n✨ Kidpen Setup Complete! ✨\n")

        self.console.info("Kidpen is configured with your API keys and ready to use.")
        ...
        if self.config.setup_method == SetupMethod.DOCKER:
            self.console.info("Your Kidpen instance is ready to use!")
            ...
            self.console.info("To start Kidpen, run these commands in separate terminals:")
        ...
        self.console.print("\nOnce all services are running, access Kidpen at: http://localhost:3000")
